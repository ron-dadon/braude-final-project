...
;(function ($, window, undefined)
{
    ...
    */
    ...
    function loadData()
    {
        ...
        {
            var column,
                searchPattern = new RegExp(that.searchPhrase, (that.options.caseSensitive) ? "gi" : "gi");
    ...
    Grid.defaults = {
        ...
        rowCount: [5, 10, 20, -1], // rows per page int or array of int (-1 represents "All")
        ...
        templates: {
            ...
            search: "<div class=\"{{css.search}}\"><div class=\"input-group\"><span class=\"{{css.icon}} input-group-addon {{css.iconSearch}}\"></span> <input type=\"text\" class=\"{{css.searchField}}\" placeholder=\"{{lbl.search}}\" /><span class=\"input-group-btn\"><button type=\"button\" class=\"btn btn-default\">Reset</button></span></div></div>",
