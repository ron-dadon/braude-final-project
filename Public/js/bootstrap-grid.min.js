...
;(function ($, window, undefined)
{
    ...
    function loadData()
    {
        ...
        {
            var searchPhrases = that.searchPhrase.split(",");
            var column;
            var searchPattern = [];
            for (var j = 0; j < searchPhrases.length; j++)
            {
                if (searchPhrases[j] !== '')
                {
                    searchPhrases[j] = searchPhrases[j].trim();
                    searchPattern.push(new RegExp(searchPhrases[j], (that.options.caseSensitive) ? "g" : "gi"))
                }
            }
            var found = [];
            ...
            for (var i = 0; i < that.columns.length; i++)
            {
                ...
                for (var z = 0; z < searchPattern.length; z++)
                {
                    if (column.searchable && column.visible &&
                        column.converter.to(row[column.id]).search(searchPattern[z]) > -1)
                    {
                        found[z] = true;
                    }
                }
    ...
    Grid.defaults = {
        ...
        templates: {
            ...
            headerCell: "<th data-column-id=\"{{ctx.column.id}}\" class=\"{{ctx.css}}\"><a href=\"javascript:void(0);\" class=\"{{css.columnHeaderAnchor}} {{ctx.sortable}}\"><span class=\"{{css.columnHeaderText}}\">{{ctx.column.text}}</span><span class=\"{{css.icon}} fa-sort\">  </span></a></th>",
            ...
            search: "<div class=\"{{css.search}}\"><div class=\"input-group\"><span class=\"input-group-addon\"><i class=\"{{css.icon}} fa-search\"></i></span> <input type=\"text\" class=\"{{css.searchField}}\" placeholder=\"{{lbl.search}}\" /></div></div>",
