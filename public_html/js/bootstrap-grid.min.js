...
;(function ($, window, undefined)
{
        ...
        firstHeadRow.children().each(function ()
        {
            var $this = $(this),
                ...
                column = {
                    ...
                    headerAlign: data.headerAlign || "right",
    ...
    Grid.defaults = {
        ...
        css: {
            ...
            left: "text-left",
            pagination: "pagination pagination-sm", // must be a unique class name or constellation of class names within the header and footer
        ...
        labels: {
            all: "הכל",
            infos: "מציג רשומות {{ctx.start}} עד {{ctx.end}} מתוך {{ctx.total}} רשומות",
            loading: "טוען נתונים...",
