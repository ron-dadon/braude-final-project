 ...
 */
class Mailer_Library extends Library
{
    ...
    public function send($to, $subject, $body, $altBody = '', $attachments = [], $cc = [], $bcc = [], $credentials = [])
    {
        ...
        $mail = new PHPMailer();
        $mail->IsSMTP();
        $mail->SMTPAuth = isset($credentials['secure']) ?
            $credentials['secure'] :
            $this->_configuration->get('email', 'secure');
        $mail->SMTPSecure = isset($credentials['security']) ?
            $credentials['security'] :
            $this->_configuration->get('email', 'security');
