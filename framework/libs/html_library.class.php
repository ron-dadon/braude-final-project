 ...
 * Class Html_Library
 */
class Html_Library extends Library
{
    /**
     * Public base path
     *
    ...
    function __construct($configuration, $request)
    {
        ...
        $this->_base = $configuration->get('paths', 'public');
        $this->set_paths();
    }
     ...
     */
    public function element($type, $content, $attributes = array())
    {
     ...
     */
    public function anchor($link, $content, $attributes = array())
    {
     ...
     */
    public function article($content, $attributes = array())
    {
     ...
     */
    public function aside($content, $attributes = array())
    {
     ...
     */
    public function audio($srcMp3, $srcOgg = '', $noSupport = 'No support', $attributes = array())
    {
     ...
     */
    public function bdo($content, $direction = 'ltr', $attributes = array())
    {
     ...
     *                              otherwise
     */
    public function block_quote($content, $link, $attributes = array())
    {
     ...
     */
    public function button($content, $attributes = array())
    {
     ...
     */
    public function canvas($attributes = array())
    {
     ...
     */
    public function cite($content, $attributes = array())
    {
     ...
     * @return string               String representing the description list item
     */
    public function description_list($items, $attributes = array())
    {
     ...
     */
    public function emphasized($content, $attributes = array())
    {
     ...
     */
    public function embed($file, $attributes = array())
    {
        $attributes['src'] = $file;
     ...
     */
    public function field_set($content, $legend = '', $attributes = array())
    {
        if ($legend !== '')
        {
     ...
     */
    public function figure($caption, $file, $attributes = array())
    {
     ...
     */
    public function footer($content, $attributes = array())
    {
     ...
     */
    public function form($content, $method = 'post', $attributes = array())
    {
     ...
     */
    public function h($size, $content, $attributes = array())
    {
        if ($size >= 1 && $size <= 6)
        {
     ...
     */
    public function header($content, $attributes = array())
    {
     ...
     */
    public function i($content, $attributes = array())
    {
     ...
     */
    public function ins($content, $attributes = array())
    {
     ...
     */
    public function kbd($content, $attributes = array())
    {
     ...
     */
    public function label($content, $for = '', $attributes = array())
    {
        $attributes['for'] = $for;
     ...
     */
    public function list_item($content, $attributes = array())
    {
     ...
     */
    public function main($content, $attributes = array())
    {
     ...
     */
    public function mark($content, $attributes = array())
    {
     ...
     */
    public function nav($content, $attributes = array())
    {
     ...
     */
    public function no_script($content, $attributes = array())
    {
     ...
     */
    public function object($url, $attributes = array())
    {
        if (filter_var($url, FILTER_VALIDATE_URL))
        {
            $attributes['data'] = $url;
     ...
     */
    public function ordered_list($items = array(), $attributes = array())
    {
     ...
     */
    public function select($items, $name, $selected = '', $attributes = array())
    {
        $options = array();
        foreach ($items as $value => $label)
        {
            if (is_array($label))
            {
                ...
                $options[] = $this->element('optgroup', implode('', $subOptions), array('label' => $value));
            }
            else
            {
     ...
     */
    public function paragraph($content, $attributes = array())
    {
     ...
     */
    public function pre($content, $attributes = array())
    {
     ...
     */
    public function progress($value, $max = '100', $attributes = array())
    {
        $attributes['max'] = $max;
        $attributes['value'] = $value;
     ...
     */
    public function quote($content, $attributes = array())
    {
     ...
     */
    public function section($content, $attributes = array())
    {
     ...
     */
    public function small($content, $attributes = array())
    {
     ...
     * @return string               String representing the span
     */
    public function span($content, $attributes = array())
    {
     ...
     */
    public function strong($content, $attributes = array())
    {
     ...
     */
    public function sub_script($content, $attributes = array())
    {
     ...
     */
    public function super_script($content, $attributes = array())
    {
     ...
     */
    public function table($cols, $cells, $footer, $attributes = array())
    {
        $columns = '<tr>' . PHP_EOL;
        foreach ($cols as $col)
        {
     ...
     */
    public function text_area($content, $attributes = array())
    {
     ...
     */
    public function time($content, $attributes = array())
    {
     ...
     */
    public function title($content, $attributes = array())
    {
     ...
     */
    public function underlined($content, $attributes = array())
    {
     ...
     */
    public function unordered_list($items = array(), $attributes = array())
    {
        $content = implode(PHP_EOL, $items);
     ...
     */
    public function variable($content, $attributes = array())
    {
     ...
     */
    public function video($srcMp4, $srcOgg = '', $noSupport = 'No support', $attributes = array())
    {
