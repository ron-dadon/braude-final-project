...
<div class="container-fluid">
    <div class="page-head bg-main">
        <h1><i class="fa fa-fw fa-file-text"></i> Invoice from Quote: <?php echo $this->escape(str_pad($quote->id, 8, '0', STR_PAD_LEFT)) ?></h1>
    </div>
        ...
        <div class="row">
            <div class="col-xs-12">
                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="col-xs-12">
                            <textarea name="invoice_note" class="form-control" style="resize: vertical"></textarea>
                        </div>
                    </div>
                </div>
            </div>
