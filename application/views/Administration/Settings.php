    ...
    <div class="row">
        ...
        <div class="panel panel-default">
            <div class="panel-footer text-right">
                ...
                <button id="save-button" class="btn btn-primary hidden-xs"><i class="fa fa-fw fa-check"></i> Save</button>
                <button id="save-button-xs" class="btn btn-primary  btn-block visible-xs"><i class="fa fa-fw fa-check"></i> Save</button>
