        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="mobile-menu">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li<?php if ($this->currentMenuItem === 'Administration'): ?> class="active"<?php endif; ?>><a href="<?php $this->publicPath() ?>Administration"><i class="fa fa-fw fa-cogs"></i> Administration</a></li>
