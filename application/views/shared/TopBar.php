        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="mobile-menu">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li<?php if ($this->currentMenuItem === 'Profile'): ?> class="active"<?php endif; ?>><a href="<?php $this->publicPath() ?>Profile"><i class="fa fa-fw fa-user"></i> <?php echo $this->currentUser->firstName . ' ' . $this->currentUser->lastName ?></a></li>
